import { hasTrait, isHookImmune } from '../core/traits';
import { ALL_CELLS, attackPath, canPlace } from '../core/geometry';
import { allegiance, getStats, passive, template } from '../core/state';
