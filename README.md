...
炎魔之心仍以3张未装备手牌合成；其他配方使用场上棋子。材料移除不触发亡语、不送人头；结果不继承装备和强化。炎魔之王改为仅己方回合末13×13最高血目标与敌方四向溅射。详见 [2.5规则与实施边界](docs/CHANGELOG-2.5.md)。3.0神龛模式、善铁、剔除普通召唤池均未实现。
...
冲锋号令储存期限已确认**8回合**；善铁和相关合成属于暂缓的**3.0神龛模式**，不再作为当前2.x未完成项。这一段记录当时的范围；2.5由作者新增的七种合成以及炎魔之王修改已覆盖对应旧描述。
